...
const programming_language_div_style = [
    "background-image: linear-gradient(to bottom, rgba(255,255,255,0.1), rgba(255,255,255,0.4)); padding: 0.5vw; margin: 0vw;", /*This is for General-Programming-Knowledge which is not visible nor available for selection*/
    "background-image: linear-gradient(to bottom, rgba(0,0,255,0.1), rgba(255,255,255,0.4)); padding: 0.5vw; margin: 0vw;", 
    "background-image: linear-gradient(to bottom, rgba(255,0,0,0.1), rgba(255,255,255,0.4));  padding: 0.5vw; margin: 0vw;", 
    "background-image: linear-gradient(to bottom, rgba(0,255,0,0.1), rgba(255,255,255,0.4)); padding: 0.5vw; margin: 0vw;",
    "background-image: linear-gradient(to bottom, rgba(0,255,255,0.1), rgba(255,255,255,0.4));  padding: 0.5vw; margin: 0vw;", 
    "background-image: linear-gradient(to bottom, rgba(255,0,255,0.1), rgba(255,255,255,0.4)); padding: 0.5vw; margin: 0vw;", 
    "background-image: linear-gradient(to bottom, rgba(255,255,0,0.1), rgba(255,255,255,0.4));  padding: 0.5vw; margin: 0vw;"
];
...
const language_title_style = "color: #663300; font-size: 17px; font-weight: bold; text-transform: uppercase; border: solid 2px white; text-align: center;  background-image: radial-gradient(circle, rgba(255,255,255,0.3), rgba(0,0,0,0.1)); margin: 1% 0%;";
const concept_title_style = "vertical-align: top; color: darkred; font-size: 16px; text-transform: capitalize; letter-spacing: 1px; text-align: left; border: double 2px white; background-image: linear-gradient(to right, rgba(255,255,255,0.4), rgba(255,255,255,0.1)); margin: 1% 0%;";
const concept_value_style = "vertical-align: top; color: black; font-family: Tahoma; font-size: 15px; text-align: left; border: solid 1px white; margin: 1% 0%;";
